				...
				case VALUE_STRING:
					if( val.className ) {
						...
						if( fp && fp.cb ) {
							...
							// object instead of throwing. The old "Double string error" made a tagged
							// string the one form that could not reach a consumer which had not
							// registered the type, against contract A at the top of the 1.2.126 tests.
							return val.string;
						}
					}
					return val.string;
