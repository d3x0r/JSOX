...
function privateizeEverything() {
  ...
  JSOX.begin = function(c, k) {
    ...
    let g = 0, h;
    var u = new Map, b = 0, m = !0, n = !1, K = null, q = null, w = void 0, y = [], M = {first:null, last:null, saved:null, push(a) {
      var b = this.saved;
      ...
      this.length--;
      return a.node;
    }, length:0}, z = [], C = {}, r = null, J = 0, x = -1, d = 0, L = 0, v = !1, Z = !1, S = !1, fa = !1, ha = !1, l = {first:null, last:null, saved:null, push(a) {
      var b = this.saved;
      b ? (this.saved = b.next, b.node = a, b.next = null, b.prior = this.last) : b = {node:a, next:null, prior:this.last};
      this.last || (this.first = b);
      this.last = b;
    ...
    return {registerFromJSOX(a, b) {
      ...
      function U() {
        ...
        switch(a.value_type) {
          ...
          case 13:
            if (0 <= x) {
              return b = ra(a.string), 0 === x ? b : new ta[x](b);
            }
            if (-2 === x) {
              b = q;
      ...
      function Y() {
        ...
        0 < b && 29 > b && E();
        if (0 == d) {
          29 == b && a.string.length ? (u.get(a.string) ? a.className = a.string : R.get(a.string) && (a.className = a.string), (e = z.find((b) => b.name === a.string)) ? (n = Object.assign(n, e.protoObject), Object.setPrototypeOf(n, Object.getPrototypeOf(e.protoObject)), c = 6) : (z.push(e = {name:a.string, protoObject:C[a.string] || Object.create({}), fields:[]}), c = 5), b = 0) : (c = 3, b = 29);
        } else {
          if (29 == b || 1 === d || 4 === d) {
            0 != b ? (u.get(a.string) ? a.className = a.string : R.get(a.string) && (a.className = a.string), (e = z.find((b) => b.name === a.string)) || t("Referenced class " + a.string + " has not been defined", f), n = Object.assign(n, e.protoObject), Object.setPrototypeOf(n, Object.getPrototypeOf(e.protoObject)), c = 6) : c = 3, b = 0;
          } else {
            if (3 == d && 0 == b) {
        ...
        }
        {
          let b = ka();
          a.value_type = 6;
          0 === d ? w = n : 1 == d ? -1 == x && y.push(n) : 4 == d && (w[a.name] = n);
          b.context = d;
          b.elements = w;
          b.element_array = y;
          b.name = a.name;
      ...
      function na() {
        ...
        if (29 == b && a.string.length) {
          ...
          0 <= c ? (b = 0, x = c) : "ref" === a.string ? x = -2 : u.get(a.string) ? a.className = a.string : R.get(a.string) ? a.className = a.string : t("Unknown type specified for array:" + a.string, f);
        } else {
          if (3 == d || 29 == b || 30 == b) {
        ...
        }
        {
          ...
          a.value_type = 13;
          let b = [];
          0 == d ? y = b : 1 == d ? -1 == x && y.push(b) : 4 == d && (w[a.name] = b);
          c.context = d;
          c.elements = w;
          c.element_array = y;
          c.name = a.name;
      ...
      for (; m && (Q = l.shift());) {
        ...
        for (A && ja(); !H && m && g < I.length;) {
          ...
          switch(f) {
            ...
            case 125:
              31 == b && (b = 0);
              5 == d ? r ? (a.string && (r.protoObject[a.string] = void 0, r.fields.push(a.string)), F(), c = M.pop(), b = d = 0, a.name = c.name, w = c.elements, y = c.element_array, r = c.current_class, J = c.current_class_field, x = c.arrayType, a.className = c.className, q = null, X.push(c)) : t("State error; gathering class fields, and lost the class", f) : 3 == d || 6 == d ? (0 != a.value_type && (r && (a.name = r.fields[J++]), da()), a.value_type = 6, a.contains = w, a.string = "", c = M.pop(), 
              d = c.context, a.name = c.name, w = c.elements, y = c.element_array, r = c.current_class, J = c.current_class_field, x = c.arrayType, a.className = c.className, X.push(c), 0 == d && (H = !0)) : 4 == d ? (0 != a.value_type && da(), a.value_type = 6, a.contains = w, c = M.pop(), a.name = c.name, d = c.context, a.name = c.name, w = c.elements, r = c.current_class, J = c.current_class_field, x = c.arrayType, a.className = c.className, y = c.element_array, X.push(c), 0 == d && (H = !0)) : 
              (t("Fault while parsing; unexpected", f), m = !1);
              n = !1;
              break;
            case 93:
              31 == b && (b = 0);
              1 == d ? (0 != a.value_type && W(), a.contains = y, c = M.pop(), a.name = c.name, d = c.context, w = c.elements, r = c.current_class, J = c.current_class_field, x = c.arrayType, a.className = c.className, y = c.element_array, X.push(c), a.value_type = 13, 0 == d && (H = !0)) : (t(`bad context ${d}; fault while parsing`, f), m = !1);
              n = !1;
              break;
            case 44:
              if (31 == b || 29 == b) {
    ...
    function a(a, K, F) {
      ...
      function y(a, g) {
        ...
        switch(typeof l) {
          ...
          case "number":
            var p = "";
            "" === a && (p = e.map((a) => a.name + "{" + a.fields.join(",") + "}").join(z ? "\n" : "") + (z ? "\n" : ""));
          ...
          case "object":
            ...
            if (v && "object" === typeof v) {
              ...
              B = k(l, v);
              for (A = 0; A < G; A += 1) {
                "string" === typeof v[A] && (p = v[A], u[F] = p, (h = y(p, l)) && (B ? g.push(h) : g.push(n(p) + (z ? ": " : ":") + h)));
              }
            } else {
              B = k(l);
              A = [];
              ...
              for (G = 0; G < A.length; G++) {
                p = A[G], Object.prototype.hasOwnProperty.call(l, p) && (u[F] = p, (h = y(p, l)) && (B ? g.push(h) : g.push(n(p) + (z ? ": " : ":") + h)));
              }
            }
            u.splice(F, 1);
            l = "" === a ? e.map((a) => a.name + "{" + a.fields.join(",") + "}").join(z ? "\n" : "") + (z ? "\n" : "") : "";
            w && w.external && (l = "" === a ? l + w.name : l + '"' + w.name + '"');
            a = null;
            B && (a = n(B.name));
            h = l + (0 === g.length ? "{}" : z ? (B ? a : "") + "{\n" + z + g.join(",\n" + z) + "\n" + r + "}" : (B ? a : "") + "{" + g.join(",") + "}");
            z = r;
            return h;
        }
      }
